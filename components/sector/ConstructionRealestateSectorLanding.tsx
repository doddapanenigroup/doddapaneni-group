...
export default async function ConstructionRealestateSectorLanding({ locale }: Props) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-amber-950 to-stone-900 px-4 pt-20 pb-8 sm:px-6 sm:pt-20 sm:pb-10 lg:px-8 lg:pt-20 lg:pb-12">
        <div
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-sm leading-relaxed text-amber-100/95 md:text-base">
            {t('heroLead')}
          </p>
          {heroDescription ? (
