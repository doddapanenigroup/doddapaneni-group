...
const blendedCardShell = `overflow-hidden !p-0 ${dashboardNestedCardClass}`;
const blendedCardHeader =
  'bg-slate-50/95 px-4 py-3 dark:bg-slate-800/50';
...
export const MarketerBlogFields = forwardRef<MarketerBlogFieldsHandle, Props>(function MarketerBlogFields(
  ...
  return (
    <div className="space-y-4">
      <div className={blendedCardShell}>
        <div className={blendedCardHeader}>
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Content, SEO &amp; media</p>
          <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
            Core article fields, search metadata, and images in one scrollable card.
          </p>
        </div>
        <div className="space-y-8 border-t border-slate-100 p-4 dark:border-slate-800">
          <section className="space-y-3">
            <h3 className={sectionHeadingClass}>1. Core content &amp; author</h3>
          ...
          <section className="space-y-3 border-t border-slate-100 pt-8 dark:border-slate-800">
            <h3 className={sectionHeadingClass}>2. SEO &amp; URL</h3>
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="sm:col-span-2">
          ...
          <section className="space-y-3 border-t border-slate-100 pt-8 dark:border-slate-800">
            <h3 className={sectionHeadingClass}>3. Media</h3>
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
