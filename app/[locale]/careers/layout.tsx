...
export async function generateMetadata({
  ...
  const t = createTranslator(getDictionary(locale), 'CareersPage');
  ...
  const path = publicPathWithLocale(locale, 'careers');
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: alternateLanguagesForPathname(origin, '/careers'),
    },
    openGraph: {
      title: ogTitle,
