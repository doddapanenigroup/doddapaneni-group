...
export async function generateMetadata({
  ...
  const t = createTranslator(getDictionary(locale), 'PrivacyPolicy');
  ...
  const path = publicPathWithLocale(locale, 'privacy-policy');
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: alternateLanguagesForPathname(origin, '/privacy-policy'),
    },
    openGraph: {
      title: ogTitle,
