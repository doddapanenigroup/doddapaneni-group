 ...
 */
export function publishedBlogWhere(now: Date): Prisma.BlogWhereInput {
  return {
    status: 'published',
...
export function publishedBlogWhereForSector(sectorId: string, now: Date): Prisma.BlogWhereInput {
  return {
